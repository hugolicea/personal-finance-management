...
class InvestmentSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        decimal_fields = ['quantity', 'purchase_price', 'current_price', 'total_invested', 'current_value',
                          'gain_loss', 'gain_loss_percentage', 'principal_amount', 'interest_rate', 'term_years']
...
class HeritageSerializer(serializers.ModelSerializer):
    gain_loss = serializers.ReadOnlyField()
    gain_loss_percentage = serializers.ReadOnlyField()
    annual_rental_income = serializers.ReadOnlyField()
    rental_yield_percentage = serializers.ReadOnlyField()
