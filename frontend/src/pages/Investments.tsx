...
function Investments() {
    ...
    const [showDeleteInvestmentDialog, setShowDeleteInvestmentDialog] =
        useState(false);
    ...
    return (
        <div className='px-4 sm:px-6 lg:px-8'>
            ...
            {/* Add Investment Button - Positioned below the header */}
                                                ...
                                                <div>
                                                    ...
                                                    >
                                                        ...
                                                        0
                                                            ? '+'
                                                            : ''}
                                                        {investment.gain_loss_percentage.toFixed(
                                                            2
                                                        )}
                                                        %
                                                    </span>
